export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'Specializing in Helping Expats with Utilities (Internet/Electricity/Gas), insurance and Mortgages. Services completely FREE of charge.',
      ctaPrimary: 'Get in Touch',
      ctaSecondary: 'Discover Services',
      stat1: 'Years of Experience',
      stat2: 'English Service',
    ...
    contact: {
      ...
      successDescription: 'I will get in touch with you shortly.',
    ...
    footer: {
      ...
      tagline: 'Multi services at your disposal'
    },
    whatsapp: {
  ...
  fr: {
    ...
    contact: {
      ...
      successDescription: 'Je vous contacterai sous peu.',
    ...
    footer: {
      ...
      tagline: 'Multi services à votre disposition'
    },
    whatsapp: {
  ...
  pt: {
    ...
    hero: {
      ...
      subtitle: 'Especializado em Ajudar clientes com diversos serviços (Internet/Eletricidade/Gás), Seguros e Hipotecas. Serviços completamente GRATUITOS.',
      ctaPrimary: 'Entre em Contacto',
      ctaSecondary: 'Conheça os Serviços',
      stat1: 'Anos de Experiência',
      stat2: 'Atendimento em Inglês',
    ...
    contact: {
      ...
      serviceDefault: 'Selecione um serviço...',
      serviceOther: 'Outro',
      messageLabel: 'Mensagem *',
      messagePlaceholder: 'Como posso ajudá-lo?',
      submitButton: 'Enviar Mensagem',
      successTitle: 'Mensagem enviada!',
      successDescription: 'Entrarei em contacto consigo brevemente.',
    ...
    footer: {
      ...
      tagline: 'Multi serviços ao seu dispor'
    },
    whatsapp: {
